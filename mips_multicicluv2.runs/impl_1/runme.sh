...
HD_PWD='C:/Users/elena/OneDrive/Desktop/facultate/an3/ssc/lab/mips_multicicluv2/mips_multicicluv2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_env.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_env.tcl -notrace
