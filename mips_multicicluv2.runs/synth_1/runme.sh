...
HD_PWD='C:/Users/elena/OneDrive/Desktop/facultate/an3/ssc/lab/mips_multicicluv2/mips_multicicluv2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_env.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_env.tcl
